...
@wroom_blueprint.route("/users/<user_id>", methods=["GET"])
def get_single_user(user_id):
    ...
    try:
        ...
        if not user:
            ...
            response_object = {
                "status": "success",
                "data": {"id": user.id, "username": user.username, "email": user.email, "active": user.active},
            }
...
@wroom_blueprint.route("/users", methods=["GET"])
def get_all_users():
    """Get all users"""
